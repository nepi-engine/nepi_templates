...
APP_NODE_NAME = 'app_data_connect'

# The connect namespace name the app's ConnectDataIF publishes under.
# Must match CONNECT_NAME in connect_data_if.py.
CONNECT_NAME = 'data_connect'


class ConnectAppDataConnect:
    msg_if = None
    ready = False
    namespace = '~'
    ...
    def __init__(self, namespace=None):
        ...
        # The select_topic subscriber lives on the app's data_connect namespace,
    ...
    def get_available_topics(self):
        """Return the data source topics the app currently sees as available."""
        if self.status_msg is not None:
            return list(self.status_msg.available_topics)
        return []

    def get_selected_topic(self):
        """Return the data source topic currently selected in the app's data_connect selector."""
        if self.status_msg is not None:
            return self.status_msg.selected_topic
        return 'None'

    def select_topic(self, topic):
        """Select which data source the app connects to.

        Args:
            topic (str): The data source topic to connect to, or 'None' to disconnect.
        """
        msg = String()
        msg.data = topic
