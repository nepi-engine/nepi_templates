...
class NepiAppNPXConnect extends Component {
  ...
  // The connect namespace the Nepi_IF_ConnectNPX component subscribes to, i.e.
  // <app>/npx_connect, matching CONNECT_NAME in connect_device_if_npx.py.
  getConnectNamespace() {
...
export default NepiAppNPXConnect
