...
APP_NODE_NAME = 'app_lsx_connect'

# The connect namespace name the app's ConnectLSXDeviceIF publishes under.
# Must match CONNECT_NAME in connect_device_if_lsx.py.
CONNECT_NAME = 'lsx_connect'


class ConnectAppLSXConnect:
    msg_if = None
    ready = False
    namespace = '~'
    ...
    def __init__(self, namespace=None):
        ...
        # The select_topic subscriber lives on the app's lsx_connect namespace,
    ...
    def get_available_topics(self):
        """Return the LSX device topics the app currently sees as available."""
        if self.status_msg is not None:
            return list(self.status_msg.available_topics)
        return []

    def get_selected_topic(self):
        """Return the device topic currently selected in the app's lsx_connect selector."""
        if self.status_msg is not None:
            return self.status_msg.selected_topic
        return 'None'

    def select_topic(self, topic):
        """Select which LSX device the app connects to.
