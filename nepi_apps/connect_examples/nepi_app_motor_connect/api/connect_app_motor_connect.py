...
APP_NODE_NAME = 'app_motor_connect'

# The connect namespace name the app's ConnectMotorsDeviceIF publishes under.
# Must match CONNECT_NAME in connect_device_if_motor.py.
CONNECT_NAME = 'motor_connect'


class ConnectAppMotorConnect:
    msg_if = None
    ready = False
    namespace = '~'
    ...
    def __init__(self, namespace=None):
        ...
        # The select_topic subscriber lives on the app's motor_connect namespace,
    ...
    def get_available_topics(self):
        """Return the motorized device topics the app currently sees as available."""
        if self.status_msg is not None:
            return list(self.status_msg.available_topics)
        return []

    def get_selected_topic(self):
        """Return the device topic currently selected in the app's motor_connect selector."""
        if self.status_msg is not None:
            return self.status_msg.selected_topic
        return 'None'

    def select_topic(self, topic):
        """Select which motorized device the app connects to.
