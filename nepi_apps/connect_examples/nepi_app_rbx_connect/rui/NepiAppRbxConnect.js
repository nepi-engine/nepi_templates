...
class NepiAppRbxConnect extends Component {
  ...
  // The connect namespace the Nepi_IF_ConnectRBX component subscribes to, i.e.
  // <app>/rbx_connect, matching CONNECT_NAME in connect_device_if_rbx.py.
  getConnectNamespace() {
...
export default NepiAppRbxConnect
