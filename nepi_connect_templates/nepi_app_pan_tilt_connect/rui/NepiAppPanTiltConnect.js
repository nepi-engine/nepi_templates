...
// controls rendering is handled by the reusable Nepi_IF_ConnectPTX component,
// which subscribes to that connect namespace and to the selected device's
// DevicePTXStatus. This page just resolves the connect namespace and renders it.
